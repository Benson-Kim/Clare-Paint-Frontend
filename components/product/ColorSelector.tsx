  ...
  return (
    <div className="space-y-4">
          ...
          >
            <div className="flex flex-col items-center space-y-2">
              ...
              <div className="text-center">
                <p className="text-sm font-medium text-[#2C2C2C]">{color.name}</p>
                {!color.inStock && (
            ...
            {color.id === selectedColor.id && (
              <div className="absolute inset-0 rounded-lg ring-2 ring-[#5B7B7A]/20" />
            )}
          </button>
        ))}
      </div>
      ...
      <div className="bg-gray-50 p-4 rounded-lg">
        <h4 className="text-sm font-semibold text-[#2C2C2C] mb-2">Color Details</h4>
        <div className="space-y-1 text-sm text-gray-600">
          <p><span className="font-medium">Hex:</span> {selectedColor.hex}</p>
          <p><span className="font-medium">RGB:</span> {selectedColor.rgb.r}, {selectedColor.rgb.g}, {selectedColor.rgb.b}</p>
          <p className={cn(
            "font-medium",
