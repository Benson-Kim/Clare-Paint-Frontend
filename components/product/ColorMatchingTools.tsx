	...
	return (
		<div className="space-y-6">
			...
			{activeTab === "visualizer" && (
				<div className="space-y-4">
					<div className="flex items-center space-x-4 mb-4">
						<Eye className="w-5 h-5 text-ds-primary-sage" />
					...
					<div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
						{roomTypes.map((room) => (
							...
							>
								<div className="relative w-full h-16 rounded mb-2 overflow-hidden">
									<Image
										src={room.image}
										alt={room.name}
										fill
								...
								<p className="text-xs font-medium text-ds-primary-charcoal">
									{room.name}
								</p>
							</button>
						))}
					...
					<div className="relative bg-gray-100 rounded-lg overflow-hidden">
						<div className="relative w-full h-64">
							<Image
								...
								alt={currentRoom?.name || "Room Preview"}
								fill
								className="object-cover"
								sizes="100vw"
							/>
					...
					<div className="flex space-x-3">
						<button className="flex-1 py-2 px-4 bg-ds-primary-sage text-white rounded-lg hover:bg-ds-primary-sage/90 transition-colors duration-200 flex items-center justify-center space-x-2">
							<Download className="w-4 h-4" />
							<span>Save Visualization</span>
						</button>
						<button className="flex-1 py-2 px-4 border border-ds-primary-sage text-ds-primary-sage rounded-lg hover:bg-ds-primary-sage/5 transition-colors duration-200 flex items-center justify-center space-x-2">
			...
			{activeTab === "matcher" && (
				<div className="space-y-4">
					<div className="flex items-center space-x-4 mb-4">
						<Pipette className="w-5 h-5 text-ds-primary-sage" />
						<h4 className="font-medium text-ds-primary-charcoal">
							Color Matcher
						</h4>
					</div>
					...
					{/* Upload Section */}
					<div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-ds-primary-sage transition-colors duration-200">
						<input
							type="file"
							accept="image/*"
						...
						<label htmlFor="image-upload" className="cursor-pointer">
							...
							<p className="text-sm text-gray-600 mb-1">
								Upload an image to match colors
							</p>
							...
							<div className="grid grid-cols-2 md:grid-cols-4 gap-3">
								{colors.slice(0, 4).map((color) => (
									<button
										...
										className="p-3 border border-gray-200 rounded-lg hover:border-ds-primary-sage transition-colors duration-200"
									>
										<div
					...
					<div>
						<h5 className="font-medium text-ds-primary-charcoal mb-3">
							Complementary Colors
						</h5>
						<div className="grid grid-cols-2 md:grid-cols-4 gap-3">
							{complementaryColors.map((color, index) => (
								...
								>
									...
									<p className="text-xs text-ds-primary-sage">
										{color.match} match
									</p>
								</div>
							))}
				...
				<div className="space-y-4">
					...
					<div className="bg-ds-primary-cream/30 p-4 rounded-lg">
						...
						<p className="text-sm text-gray-600 mb-4">
							Order up to 5 free color samples to see how they look in your
							space.
						</p>
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							<div className="flex items-center space-x-3">
								<div className="w-8 h-8 bg-ds-primary-sage rounded-full flex items-center justify-center">
					...
					<div className="border border-gray-200 rounded-lg p-4">
						<div className="flex items-center justify-between mb-3">
							<h5 className="font-medium text-ds-primary-charcoal">
								Current Selection
							</h5>
							<span className="text-xs bg-ds-primary-sage text-white px-2 py-1 rounded-full">
								1 of 5
							</span>
						</div>
						<div className="flex items-center space-x-3">
					...
					<button className="w-full py-3 bg-ds-primary-sage text-white rounded-lg hover:bg-ds-primary-sage/90 transition-colors duration-200 font-medium">
						Order Free Samples
					</button>
				</div>
			)}
