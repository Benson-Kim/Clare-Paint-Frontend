		...
		<>
			<div className="space-y-4">
				...
				<div className="relative bg-neutral-100 rounded-lg overflow-hidden group">
					...
					>
						<div className="relative w-full h-96 md:h-[500px] overflow-hidden cursor-crosshair">
							<Image
				...
				<div className="border-t pt-4">
					<h3 className="text-sm font-medium text-ds-primary-charcoal mb-3">
						Available Colors
					</h3>
