    ...
    <div className="space-y-6">
      ...
      <div className="border-b border-gray-200 pb-6">
        ...
        {selectedFinish.price > 0 && (
          <p className="text-sm text-gray-600">
            Base price: ${product.basePrice.toFixed(2)} + ${selectedFinish.price.toFixed(2)} {selectedFinish.name} finish
          </p>
        )}
      ...
      <div className="space-y-3">
          ...
          className={cn(
            ...
            canAddToCart
              ? isAdded
                ...
                : "bg-[#5B7B7A] text-white hover:bg-[#5B7B7A]/90 hover:scale-[1.02] active:scale-[0.98]"
        ...
        <div className="flex space-x-3">
          ...
          <button
            onClick={handleShare}
            className="flex-1 py-3 px-4 rounded-lg border-2 border-gray-300 text-gray-700 font-medium hover:border-[#5B7B7A] hover:text-[#5B7B7A] transition-all duration-200 flex items-center justify-center space-x-2"
      ...
      <div className="bg-[#F5F5DC]/30 p-4 rounded-lg">
        <h4 className="font-semibold text-[#2C2C2C] mb-2">Shipping Information</h4>
