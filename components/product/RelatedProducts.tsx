...
export const RelatedProducts: React.FC<RelatedProductsProps> = ({
	...
	const relatedProducts = [
		...
		},
		{
			...
			image:
				"https://images.pexels.com/photos/3682293/pexels-photo-3682293.jpeg?auto=compress&cs=tinysrgb&w=400",
			price: 12.99,
			rating: 4.8,
		},
	];
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="text-center mb-12">
					...
					<p className="text-gray-600 max-w-2xl mx-auto">
						Essential tools and products to ensure professional results with
						your paint project.
					</p>
				</div>
					...
					{relatedProducts.map((product) => (
						...
						>
							...
							<div className="p-4">
								...
								<button className="w-full mt-3 py-2 bg-ds-primary-sage text-white font-medium rounded-lg hover:bg-ds-primary-sage/90 transition-colors duration-200">
									Add to Cart
								</button>
							</div>
						</div>
