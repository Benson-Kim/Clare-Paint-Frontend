...
export const InteriorPaintHero: React.FC<InteriorPaintHeroProps> = ({ onRoomSelect }) => {
  const roomTypes = [
    {
      id: 'living-room',
      name: 'Living Room',
  ...
  return (
    <div className="relative bg-gradient-to-r from-[#5B7B7A] to-[#2C2C2C] text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
            Discover our curated collection of interior paints designed for every room in your home. 
            From calming bedrooms to vibrant kitchens, find the perfect color and finish.
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <div className="inline-flex items-center space-x-4 bg-white/10 backdrop-blur-sm rounded-lg px-6 py-4">
            <span className="text-white/90">Need help choosing the right paint?</span>
            <button className="bg-white text-[#5B7B7A] px-6 py-2 rounded-lg font-semibold hover:bg-white/90 transition-colors duration-200">
