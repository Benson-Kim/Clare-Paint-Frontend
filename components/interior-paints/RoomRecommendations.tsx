...
export const RoomRecommendations: React.FC<RoomRecommendationsProps> = ({
  ...
  const roomData = {
    'living-room': {
      name: 'Living Room',
      description: 'High-traffic areas need durable paints that can withstand daily wear while maintaining their beauty.',
    ...
    'bedroom': {
      name: 'Bedroom',
      description: 'Create a peaceful retreat with calming colors and low-odor formulas for better sleep quality.',
    ...
    'kitchen': {
      name: 'Kitchen',
      description: 'Cooking areas require easy-to-clean finishes that resist grease, moisture, and frequent scrubbing.',
    ...
    'bathroom': {
      name: 'Bathroom',
      description: 'High-humidity environments need specialized paints that resist mold, mildew, and moisture damage.',
    ...
    'nursery': {
      name: 'Nursery',
      description: 'Baby-safe paints with zero harmful chemicals and calming colors for peaceful sleep.',
    ...
    'home-office': {
      name: 'Home Office',
      description: 'Productive workspaces benefit from colors that enhance focus and finishes that are easy to maintain.',
  ...
  const suitableProducts = products.filter(product =>
    product.features.some(feature =>
      currentRoom.idealFeatures.some(idealFeature =>
        feature.toLowerCase().includes(idealFeature.toLowerCase().replace(' ', '-'))
      )
    ) ||
  ...
  return (
    <div className="bg-[#F5F5DC]/30 border-t border-[#C4A57B]/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            onClick={onClose}
            className="p-2 text-gray-500 hover:text-[#2C2C2C] transition-colors duration-200"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="md:w-2/3">
                ...
                <div className="space-y-2">
                  <h3 className="font-semibold text-[#2C2C2C] mb-3">Expert Tips:</h3>
                  {currentRoom.recommendations.map((tip, index) => (
                    <div key={index} className="flex items-start space-x-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#5B7B7A] mt-2 flex-shrink-0" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white p-4 rounded-lg border border-gray-200">
                <div className="flex items-center space-x-2 mb-3">
                  ...
                  <h4 className="font-semibold text-[#2C2C2C]">Ideal Features</h4>
                </div>
              ...
              <div className="bg-white p-4 rounded-lg border border-gray-200">
                <div className="flex items-center space-x-2 mb-3">
                  <Droplets className="w-5 h-5 text-[#5B7B7A]" />
                  <h4 className="font-semibold text-[#2C2C2C]">Recommended Sheen</h4>
                </div>
                <ul className="space-y-1">
                  {currentRoom.sheenLevels.map((sheen, index) => (
                    <li key={index} className="text-sm text-gray-600">• {sheen}</li>
                  ))}
                </ul>
              </div>
              ...
              <div className="bg-white p-4 rounded-lg border border-gray-200">
                <div className="flex items-center space-x-2 mb-3">
                  ...
                  <h4 className="font-semibold text-[#2C2C2C]">Color Suggestions</h4>
                </div>
                <ul className="space-y-1">
                  {currentRoom.colorSuggestions.map((color, index) => (
                    <li key={index} className="text-sm text-gray-600">• {color}</li>
                  ))}
                </ul>
              </div>
            </div>
          ...
          <div>
            <h3 className="font-semibold text-[#2C2C2C] mb-4">Recommended Products</h3>
            <div className="space-y-4">
              {suitableProducts.map((product) => (
                <div key={product.id} className="bg-white p-4 rounded-lg border border-gray-200 hover:shadow-md transition-shadow duration-200">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <h4 className="font-semibold text-[#2C2C2C] mb-1">{product.name}</h4>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button className="text-[#5B7B7A] hover:text-[#5B7B7A]/80 transition-colors duration-200">
            ...
            <button className="w-full mt-4 py-3 bg-[#5B7B7A] text-white rounded-lg hover:bg-[#5B7B7A]/90 transition-colors duration-200 font-medium">
