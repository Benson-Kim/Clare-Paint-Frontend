		...
		>
			<div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
				...
				<div className="p-6">
					...
					{activeTab === "simple" ? (
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
								<div>
									...
									<input
										...
										className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ds-primary-sage focus:border-transparent"
									/>
								</div>
								<div>
									<label className="block text-sm font-medium text-ds-primary-charcoal mb-2">
						...
						<div className="space-y-6">
							...
							<div className="space-y-4">
								...
								<button
									onClick={addRoom}
									className="w-full py-3 border-2 border-dashed border-gray-300 rounded-lg text-gray-600 hover:border-ds-primary-sage hover:text-ds-primary-sage transition-colors duration-200"
								>
									+ Add Another Room
								</button>
							</div>
					...
					{/* Results */}
					<div className="mt-8 bg-ds-primary-sage/5 border border-ds-primary-sage/20 rounded-lg p-6">
					...
					<div className="flex space-x-4 mt-6">
						<button className="flex-1 py-3 bg-ds-primary-sage text-white rounded-lg hover:bg-ds-primary-sage/90 transition-colors duration-200 font-medium">
							Shop Recommended Paints
						</button>
						<button className="flex-1 py-3 border border-ds-primary-sage text-ds-primary-sage rounded-lg hover:bg-ds-primary-sage/5 transition-colors duration-200 font-medium">
							Save Calculation
						</button>
					</div>
				</div>
