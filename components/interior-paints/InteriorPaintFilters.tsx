...
export const InteriorPaintFilters: React.FC<InteriorPaintFiltersProps> = ({
	...
	const sheenLevels = [
		{
			id: "flat",
			name: "Flat (0-5%)",
			description: "Hides imperfections, low maintenance",
		},
		{
			id: "matte",
			name: "Matte (5-10%)",
			description: "Sophisticated look, easy touch-ups",
		},
		{
			id: "eggshell",
			name: "Eggshell (10-25%)",
			description: "Subtle sheen, washable",
		},
		{
			id: "satin",
			name: "Satin (25-35%)",
			description: "Durable, easy to clean",
		},
		{
			id: "semi-gloss",
			name: "Semi-Gloss (35-70%)",
			description: "High durability, moisture resistant",
		},
		{
			id: "gloss",
			name: "Gloss (70%+)",
			description: "Maximum durability and shine",
		},
	];
	...
	const coverageOptions = [
		{
			id: "standard",
			name: "Standard (300-400 sq ft)",
			description: "Most interior paints",
		},
		{
			id: "premium",
			name: "Premium (400+ sq ft)",
			description: "High-coverage formulas",
		},
	];
	...
	const features = [
		{
			id: "zero-voc",
			name: "Zero-VOC",
			description: "Healthier indoor air quality",
		},
		{
			id: "mold-resistant",
			name: "Mold & Mildew Resistant",
			description: "Perfect for humid areas",
		},
		{
			id: "stain-resistant",
		...
		},
		{
			id: "scrubbable",
			name: "Scrubbable",
			description: "Withstands frequent cleaning",
		},
		{
			id: "fade-resistant",
			name: "Fade Resistant",
				...
				{coverageOptions.map((coverage) => (
					...
					>
						<input
							...
							onChange={(e) =>
								handleCheckboxChange("coverage", coverage.id, e.target.checked)
							}
