...
export const CategoryHero: React.FC = () => {
  ...
  return (
    <div className="relative bg-gradient-to-r from-[#5B7B7A] to-[#2C2C2C] text-white">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
            Transform your space with our carefully curated selection of premium interior paints. 
            From bold statement colors to subtle neutrals, find the perfect shade for every room.
          </p>
        </div>
