...
export const returnItemSchema = z.object({
	...
	reason: z.enum(["color_issue", "damaged", "wrong_item", "other"] as const, {
...
export const returnFormSchema = z.object({
	orderId: z
		...
		.regex(
			/^ORD-\d{13}-\d{3}$/,
			"Please enter a valid Order ID (e.g., ORD-1629876543210-123)."
		),
	...
	policyAccepted: z.literal(true, {
		message: "You must accept the return policy to proceed.",
	}),
});
