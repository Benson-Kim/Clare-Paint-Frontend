...
export const metadata: Metadata = {
	...
	description:
		"Find answers to common questions about our paint products, shipping, returns, color matching, and technical support. Your guide to a smooth painting experience.",
	keywords:
		"FAQ, frequently asked questions, paint questions, shipping, returns, color matching, technical support, paint help",
	openGraph: {
		title: "FAQ - Frequently Asked Questions | Paint Store",
		description:
			"Find answers to common questions about our paint products, shipping, returns, color matching, and technical support.",
		type: "website",
		images: [
			{
