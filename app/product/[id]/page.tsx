  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gray-50 border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex items-center space-x-2 text-sm">
            <Link
              href="/"
              className="text-gray-500 hover:text-[#5B7B7A] transition-colors duration-200"
            >
              Home
            </Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Link
          href="/products"
          className="inline-flex items-center space-x-2 text-gray-600 hover:text-[#5B7B7A] transition-colors duration-200 mb-8 group"
        >
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-3 gap-4 pt-6 border-t">
              <div className="flex flex-col items-center text-center">
                <Truck className="w-6 h-6 text-[#5B7B7A] mb-2" />
                <span className="text-xs text-gray-600">Free Shipping</span>
              </div>
              <div className="flex flex-col items-center text-center">
                <RotateCcw className="w-6 h-6 text-[#5B7B7A] mb-2" />
                <span className="text-xs text-gray-600">30-Day Returns</span>
              </div>
              <div className="flex flex-col items-center text-center">
                <Shield className="w-6 h-6 text-[#5B7B7A] mb-2" />
              ...
              <div className="bg-[#F5F5DC]/30 border border-[#C4A57B]/20 rounded-lg p-6">
                ...
                <ul className="space-y-3 text-sm">
                  <li className="flex items-start space-x-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-[#5B7B7A] mt-2" />
                ...
                <button className="w-full mt-4 py-2 text-[#5B7B7A] border border-[#5B7B7A] rounded-lg hover:bg-[#5B7B7A] hover:text-white transition-all duration-200">
                  Contact Us
                </button>
              </div>
            </div>
